      ...
      <div className="relative mt-16 max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20">
          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            {tiers.map((tier) => (
              <div key={tier.id} className="col-span-1">
                ...
                <p className="mt-2 questrial-regular text-sm text-gray-500">
                  {tier.name === "SNACK"
        ...
        {comparisonData.map((section, sectionIdx) => (
          <div key={sectionIdx} className="mt-6 space-y-4 lg:space-y-0">
            {/* Category Header */}
            <ul className="grid lg:grid-cols-4 lg:gap-6">
            ...
            {section.features.map((feature, featureIdx) => (
              <ul key={featureIdx} className="grid lg:grid-cols-4 lg:gap-6">
            ...
            <div className="col-span-1">
              <a
                ...
                className={classNames(
                  ...
                  "w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg shadow-2xs questrial-regular focus:outline-none"
                )}
              >
                Get started
              </a>
